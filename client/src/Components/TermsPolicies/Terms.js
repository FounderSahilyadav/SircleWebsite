    ...
    <>
      <Box>
        <Container>
          ...
          ></div>
          <h1 className="cent">Terms and Conditions</h1>
          <p>
            Welcome to Sircle! These terms and conditions outline the rules and
            regulations for the use of SIRCLE THE SMART EDUCATION PVT. LTD.'s
            Website, located at https://www.sircle.in/. By accessing this website we
            assume you accept these terms and conditions. Do not continue to use
            Sircle if you do not agree to take all of the terms and conditions
          ...
          <h2>Cookies</h2>
          <p>
            We employ the use of cookies. By accessing Sircle, you agreed to use
            cookies in agreement with the SIRCLE THE SMART EDUCATION PVT. LTD.'s
            Privacy Policy. Most interactive websites use cookies to let us retrieve
            the user’s details for each visit. Cookies are used by our website to
          ...
          <h2>License</h2>
          <p>
            Unless otherwise stated, SIRCLE THE SMART EDUCATION PVT. LTD. and/or its
            licensors own the intellectual property rights for all material on
            Sircle. All intellectual property rights are reserved. You may access
            this from Sircle for your own personal use subjected to restrictions set
            in these terms and conditions. You must not:
            <ul>
              <li>Republish material from Sircle</li>
              <li>Sell, rent or sub-license material from Sircle</li>
              <li> Reproduce, duplicate or copy material from Sircle</li>
              <li>Redistribute content from Sircle</li>
            </ul>
            This Agreement shall begin on the date hereof. Our Terms and Conditions
            were created with the help of the Terms And Conditions Template. Parts
            of this website offer an opportunity for users to post and exchange
            opinions and information in certain areas of the website. SIRCLE THE
            SMART EDUCATION PVT. LTD. does not filter, edit, publish or review
            Comments prior to their presence on the website. Comments do not reflect
            the views and opinions of SIRCLE THE SMART EDUCATION PVT. LTD.,its
            ...
            applicable laws, SIRCLE THE SMART EDUCATION PVT. LTD. shall not be
            ...
            appearance of the Comments on this website. SIRCLE THE SMART EDUCATION
            PVT. LTD. reserves the right to monitor all Comments and to remove any
            ...
            <ul>
              ...
              <li>
                The Comments will not be usedto solicit or promote business or
                custom or present commercial activities or unlawful activity.
              </li>
            </ul>
            You hereby grant SIRCLE THE SMART EDUCATION PVT. LTD. a non-exclusive
          ...
          <p>
            ...
            the hyperlink compensates the absence of SIRCLE THE SMART EDUCATION PVT.
            LTD.; and (d) the link is in the context of general resource
            information. These organizations may link to our home page so long as
            ...
            party’s site. If you are one of the organizations listed in paragraph 2
            above and are interested in linking to our website, you must inform us
            by sending an e-mail to SIRCLE THE SMART EDUCATION PVT. LTD.. Please
            ...
            No use of SIRCLE THE SMART EDUCATION PVT. LTD.'s logo or other artwork
